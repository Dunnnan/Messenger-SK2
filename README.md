...
2)	Klasa signin - obsługuje proces logowania użytkownika umożliwiając wprowadzenie nazwy użytkownika i hasła, ich walidację oraz przesłanie do serwera. W przypadku poprawnych danych użytkownik zostaje zalogowany i przekierowany do głównego menu aplikacji, a w razie błędu wyświetlany jest odpowiedni komunikat.
